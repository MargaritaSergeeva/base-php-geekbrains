<?php
	$titleContent = 'Nunc commodo euismod massa quis vestibulum';
	$h1Content = 'Nunc commodo euismod';
	$currentYear = date('Y');	
?>
...
<head>
	...
	<title><?php echo $titleContent; ?></title>
</head>
<body>
	<div id="content">
		...
		<div id="footer">
		      <p>Copyright &copy; <?php echo $currentYear; ?> <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>